            ...
            <div className="w-full px-5 lg:px-10">
                ...
                <div className="mb-5">
                    ...
                    <div className="flex -m-3">
                        ...
                        {/* <div onClick={() => changeColor('white')} className="rounded-full m-3 cursor-pointer border-solid border-2 border-gray-700" style={{ width: '50px', height: '50px', background: 'yellow' }}></div> */}
                    </div>
                </div>
                <div className="mb-5">
                    <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
